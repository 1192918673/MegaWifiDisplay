package com.mega.wifidisplay.bluetooth;
...
import com.mega.wifidisplay.input.Report;
import com.mega.wifidisplay.input.HidDescription;
import com.mega.wifidisplay.input.TouchScreen;
...
public class HidDataSender implements BluetoothProfile.ServiceListener {
	...
	public HidDataSender(Context context,
		...
		mAdapter.getProfileProxy(mContext.getApplicationContext(), this, BluetoothProfile.INPUT_HOST);
	}
	...
	public void sendReport(Report report, Queue<ByteBuffer> queue) {
		...
		while ((temp = queue.poll()) != null) {
			Log.d(TAG, "ZZQ send report:" + temp.get(0)+":"+temp.get(1)+":"+temp.get(2));
