...
//				/* x逻辑值 */
//				(byte)0x16, (byte)0x00, (byte)0x85,              /* LOGICAL_MINIMUM (-127) */ // 这是一个全局条目，说明返回的逻辑最小为-128。
//				(byte)0x26, (byte)0x00, (byte)0x05,   /* LOGICAL_MAXIMUM (127) */  // 这是一个全局条目，说明返回的逻辑最大为127。
//				/* x物理值 */
//				(byte)0x36, (byte)0x00, (byte)0x85,
//				(byte)0x46, (byte)0x00, (byte)0x05,
...
//				/* y逻辑值 */
//				(byte)0x16, (byte)0x84, (byte)0x83,             // LOGICAL_MINIMUM (0)
//				(byte)0x26, (byte)0x84, (byte)0x03, // LOGICAL_MAXIMUM (1079)
//				/* y物理值 */
//				(byte)0x36, (byte)0x00, (byte)0x83,             // Physical Minimum (0)
//				(byte)0x46, (byte)0x84, (byte)0x03, // Physical Maximum(1079)
//				(byte)0x75, (byte)0x10,   /* REPORT_SIZE (16) */      //每个数据域的长度为16bit
//				(byte)0x95, (byte)0x01,   /* REPORT_COUNT (1) */     //数据域1个
...
//	}
	...
	final public static class Report implements com.mega.wifidisplay.input.Report {
		...
		public Report(byte id,
			...
			report.put(0, (byte)1);
			report.put(1, mBtnTouch);
			report.put(2, absX_low);
			report.put(3, absX_high);
			report.put(4, absY_low);
			report.put(5, absY_high);
		}
